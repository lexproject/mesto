...
Был произведён рефакторинг кода в результате чего, код стал объектно-ориентирован, добавление карточек мест и валаидация форм осуществляется отдельными классами.
